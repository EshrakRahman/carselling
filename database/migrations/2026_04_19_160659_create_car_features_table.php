...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('car_features', function (Blueprint $table) {
            ...
            $table->boolean('power_door_looks')->default(0);
            $table->boolean('cruise_controll')->default(0);
            $table->boolean('bluethooth_connectivity')->default(0);
            $table->boolean('remote_start')->default(0);
            $table->boolean('gps_navigation')->default(0);
            $table->boolean('heater_control')->default(0);
